...
public class ShortParserTest {
    ...
    public void parseValue() {
        assertEquals((short)1, parser.parseValue("1"));
        assertEquals((short)-5564, parser.parseValue("-5564"));
        assertEquals((short)3505, parser.parseValue("3505"));
        assertEquals((short)-8, parser.parseValue("-8"));
        assertEquals((short)0, parser.parseValue("0"));
    }
